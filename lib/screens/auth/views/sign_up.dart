                    ...
                    children: <Widget>[
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          BaseTextField(controller: emailInput, inputType: TextInputType.emailAddress, icon: Icons.email, hintText: "Nhập địa chỉ email", passwordField: false, isValidNumber: false, numberValid: null,),
                          const SizedBox(height: 18,),
                          BaseTextField(controller: nameInput, inputType: TextInputType.text, icon: Icons.person, hintText: "Nhập tên của bạn", passwordField: false, isValidNumber: false, numberValid: null,),
                          const SizedBox(height: 18,),
                          BaseTextField(controller: passwordInput, inputType: TextInputType.visiblePassword, icon: Icons.key, hintText: "Nhập mật khẩu", passwordField: true, isValidNumber: false, numberValid: null,),
                          const SizedBox(height: 18,),
                          BaseTextField(controller: passwordConfirmInput, inputType: TextInputType.visiblePassword, icon: Icons.key, hintText: "Nhập lại mật khẩu", passwordField: true, isValidNumber: false, numberValid: null,),
